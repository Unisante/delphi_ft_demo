...
if (length(selected_cols) > 0) {
  ...
  if (report_type == 'repgen') {
    ...
    flextable::flextable_to_rmd(ft_generic)
  }
  ...
  if (report_type == 'per_participant') {
    ...
    flextable::flextable_to_rmd(ft_participant)
  }
  
  # print two empty lines
  cat("\n  <br><br>  \n")
  
  ## for loop for comments: for each variable, create a separate table with comments and print as rmd
...
if (length(selected_cols) > 0) {
  ...
  for (i in selected_cols) {
    ...
    ## ft_comments is created by by 03b_ or 04b_
    flextable::flextable_to_rmd(ft_comments)
...
dt_comments_m[variable == selected_section_comment] %>% 
