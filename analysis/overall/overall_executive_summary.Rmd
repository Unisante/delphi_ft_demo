...
load(here::here('output', 'RData', 'type1_zz_combined_round_2_3.RData'))

# rm(type1_zz_combined_round_2_3)
```
...
type1_zz_combined_round_2_3 %>% sjmisc::frq(group_exec_summary)
...
t1a <- type1_zz_combined_round_2_3[group_exec_summary == 'agree_with_consensus',]
...
t1b <- type1_zz_combined_round_2_3[group_exec_summary == 'disagree_with_consensus',]
...
## subset rows ----
t2a <-
  type1_zz_combined_round_2_3[group_exec_summary %in% c('no_agree',
